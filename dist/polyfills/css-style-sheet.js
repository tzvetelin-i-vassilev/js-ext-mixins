(function (factory) {
  ...
  var CSSStyleSheetOrigin = window.CSSStyleSheet;
  var protoProps = Object.getOwnPropertyNames(CSSStyleSheetOrigin.prototype).slice(1);
  var _sheet = new WeakMap();
  var CSSStyleSheet = function () {
    function CSSStyleSheet() {
      var _this = this;
      _classCallCheck(this, CSSStyleSheet);
      _classPrivateFieldInitSpec(this, _sheet, {
        writable: true,
        value: void 0
      });
      var _iterator = _createForOfIteratorHelper(protoProps),
        _step;
      try {
    ...
    _createClass(CSSStyleSheet, [{
      key: "replaceSync",
      value: function replaceSync(text) {
  ...
  if (!CSSStyleSheetOrigin.prototype.replaceSync) window.CSSStyleSheet = CSSStyleSheet;
